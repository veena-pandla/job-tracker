...
with main_tab:
    ...
    jobs = [
        ...
        and j.get("source") not in ("greenhouse", "lever", "remoteok", "yc", "wellfound", "wayup")
    ]
...
with intern_tab:
    ...
    with icol1:
        intern_source = st.multiselect(
            "Source",
            ["greenhouse", "lever", "yc", "wellfound", "wayup", "linkedin", "indeed", "glassdoor", "zip_recruiter", "remoteok"],
